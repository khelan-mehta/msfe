...
pub async fn verify_job_seeker_payment(
    ...
    println!("Payload for signature verification: {}", payload);
    ...
    // Debug: log the subscription retrieved after verification
    println!("Subscription after verify: {:?}", subscription);
